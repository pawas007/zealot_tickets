...
## Особливосіті реалізації
1.Ролі -  як приклад я реалізував просто окремою таблицею Тільки Адмін може створювати юзерів (та додавати їм роль)





## В рамках тестового деякі логічні частини я опущені:
